...
const Navbar: React.FC = () => {
  ...
  links.forEach(link => {
    link.addEventListener('click', (event) => {
      // Loại bỏ lớp "active" từ các link khác
      links.forEach(item => item.classList.remove('text-white', 'bg-amber-700'));
      links.forEach(item => item.classList.add('hover:bg-gray-100', 'md:hover:bg-transparent', 'md:hover:text-amber-700', 'md:p-0', 'dark:text-white', 'md:dark:hover:text-amber-500', 'dark:hover:bg-gray-700', 'dark:hover:text-white', 'md:dark:hover:bg-transparent', 'dark:border-gray-700'));

      // Thêm lớp "active" vào link được nhấp
      link.classList.add('bg-amber-700', 'text-white');
      link.classList.remove('hover:bg-gray-100', 'md:hover:bg-transparent', 'md:hover:text-amber-700', 'md:p-0', 'dark:text-white', 'md:dark:hover:text-amber-500', 'dark:hover:bg-gray-700', 'dark:hover:text-white', 'md:dark:hover:bg-transparent', 'dark:border-gray-700');
    });
  });
  ...
  return (
    <nav className="bg-white border-gray-200 dark:bg-gray-900">
      ...
      {/* Search Form */}
      <form className="relative flex-1 max-w-sm mx-4 md:mx-6">   
          ...
          <div className="relative">
            ...
            <button 
              type="submit" 
              className="absolute right-2.5 bottom-1.5 bg-amber-500 hover:bg-amber-700 text-white font-medium rounded-lg text-sm px-3 py-1 dark:bg-amber-600 dark:hover:bg-amber-700 focus:ring-4 focus:outline-none focus:ring-amber-300 dark:focus:ring-amber-800"
            >
              Search
            </button>
          </div>
      ...
      <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
        <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
          <li>
            <a href="/home" className="nav-link block py-2 px-3 text-white bg-amber-700 rounded md:bg-transparent md:text-amber-700 md:p-0 md:dark:text-amber-500" aria-current="page">Home</a>
          </li>
          <li>
            <a href="#" className="nav-link block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-amber-700 md:p-0 dark:text-white md:dark:hover:text-amber-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">About</a>
          </li>
          <li>
            <a href="#" className="nav-link block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-amber-700 md:p-0 dark:text-white md:dark:hover:text-amber-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Services</a>
          </li>
          <li>
            <a href="/products/myProduct" className="nav-link block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-amber-700 md:p-0 dark:text-white md:dark:hover:text-amber-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">My Product</a>
          </li>
          <li>
            <a href="/transactions" className="nav-link block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-amber-700 md:p-0 dark:text-white md:dark:hover:text-amber-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Transactions</a>
          </li>
          <li>
            <a href="/contact" className="nav-link block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-amber-700 md:p-0 dark:text-white md:dark:hover:text-amber-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Contact</a>
          </li>
        </ul>
      </div>
      </div>
