...
const Transactions = () => {
  ...
  const handleAccept = (transactionId: number, item_buyer_id: number, item_seller_id: number) => {
    console.log("Accepted transaction with ID:", transactionId);
  
    axiosInstance.put(`/transactions/accept/${transactionId}`)
      .then((response) => {
        ...
        setTransactionsBuyer((prevTransactions) => 
          prevTransactions.map((transaction) => {
            ...
            return (transaction.item_buyer_id === item_buyer_id || transaction.item_seller_id === item_seller_id)
